import './demo-list-helper.js';
import '../../cosmoz-grouped-list.js';
/*global Polymer*/
class DemoFull extends Polymer.Element {
	static get template() {
		return Polymer.html`
		...
		<div class="layout vertical fit">
			...
			<div class="layout horizontal center wrap">
				...
				<button class="action" on-tap="_changeItemValue">change item value</button>
...
`;
	...
	connectedCallback() {
		...
		window.setTimeout(function () {
			this.data = Cosmoz.Demo.generateListDemoData(10, 13, 1, 7);
		}.bind(this), 16);
	}
	...
	_newData() {
		this.data = Cosmoz.Demo.generateListDemoData(10, 15, 1, 7);
	}

	_newSmallData() {
		this.data = Cosmoz.Demo.generateListDemoData(1, 1, 2, 3);
	}

	_newFlatData() {
		const data = Cosmoz.Demo.generateListDemoData(3, 3, 50, 80);
